...
/*
  El recursivo tarda mas que el iterativo ya que tiene que ir cargando las
  llamadas a las siguientes funciones al stack, mientras que el iterativo
  solo va guardando los ultimos 2 resultados y va actualizando esos valores,
  por lo que el iterativo tiene una complejidad de O(n) y el recursivo tiene
  una complejidad de O(2^n) debido a la cantidad de llamadas recursivas que
  se hacen.
*/