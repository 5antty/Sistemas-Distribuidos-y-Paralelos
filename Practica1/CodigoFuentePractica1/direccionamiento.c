...
// La estrategia mas rapida es la de direccionamiento a partir de un puntero,
//  ya que se evita el calculo del indice en cada iteracion, pues con el puntero
//  solo va a una posicion y luego se va corriendo a partir de la misma,
