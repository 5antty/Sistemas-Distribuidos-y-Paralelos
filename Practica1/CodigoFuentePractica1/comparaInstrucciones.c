...
int main(int argc, char *argv[])
{
	...
	// Inicializa los arreglos con potencias de 2
	for (i = 0; i < N; i++)
	{
		x[i] = potencia2();
		y[i] = potencia2();
...
/*
	La operacion que mas tiempo tarda de forma teorica es la division, pues
	es la que ocupa mas ciclos de reloj para ser ejecutada.
	Si los valores de los arreglos son potencias de 2, la division se puede
	optimizar a un corrimiento de bits, lo que reduce el tiempo de ejecucion
*/